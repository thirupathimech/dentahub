...
export default function AppointmentsPage() {
  ...
  return <div className="space-y-6 py-7">
    ...
    {formOpen && <AppointmentModal editing={editing} form={form} setForm={setForm} patients={patients} doctors={doctors} saving={saving} error={error} onClose={closeForm} onSave={requestSave} />}
